class Templates {
	verificationTemplate({ link }: { link: string }) {
														...
														>
															...
															>
																<tr>
																	...
																	>
																		<img
																			src="https://firebasestorage.googleapis.com/v0/b/xplorecreations-88ad0.appspot.com/o/Xplore-01%20(3).png?alt=media&token=3715599e-5091-4561-bfed-88991bc9ee20"
																			alt="Logo"
																			style="
																				display: block;
																				border: 0;
														...
														>
															...
															>
																<tr>
																	...
																	>
																		<img
																			src="https://yyuffj.stripocdn.email/content/guids/CABINET_67e080d830d87c17802bd9b4fe1c0912/images/55191618237638326.png"
																			alt
																			style="
																				display: block;
																				border: 0;
																		...
																		>
																			<tr>
																				...
																				>
																					<img
																						title="Facebook"
																						src="https://yyuffj.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png"
																						alt="Fb"
																						width="32"
																						style="
																							display: block;
																				...
																				>
																					<img
																						title="Twitter"
																						src="https://yyuffj.stripocdn.email/content/assets/img/social-icons/logo-black/twitter-logo-black.png"
																						alt="Tw"
																						width="32"
																						style="
																							display: block;
																				...
																				>
																					<img
																						title="Instagram"
																						src="https://yyuffj.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png"
																						alt="Inst"
																						width="32"
																						style="
																							display: block;
																				...
																				>
																					<img
																						title="Youtube"
																						src="https://yyuffj.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png"
																						alt="Yt"
																						width="32"
																						style="
																							display: block;
																...
																<tr>
																	...
																	>
																		<p
																			...
																			"
																		>
																			xplorecreations © 2021 Xplorecreations, Inc.
																			All Rights Reserved.
																		</p>
																		<p
																			style="
...
<td align="center" class="es-infoblock" style="padding:0;Margin:0;line-height:14px;font-size:12px;color:#CCCCCC"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:14px;color:#CCCCCC;font-size:12px"><a target="_blank" href="" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:12px"></a>No longer want to receive these emails?&nbsp;<a href="" target="_blank" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:12px">Unsubscribe</a>.<a target="_blank" href="" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:12px"></a></p></td>
	...
	resetPassword({ link }: { link: string }) {
		return `
 <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html
	xmlns="http://www.w3.org/1999/xhtml"
																...
																<tr>
																	...
																	>
																		<p
																			...
																			"
																		>
																			Dear valued Xplore Creations user, We have
																...
																<tr>
																	...
																	>
																		<p
																			...
																			"
																		>
																			Once confirmed, your password will be reset.
																		</p>
																	</td>
																</tr>
															</table>
